...
<p>{{ $order->location->price > 0 ? 'You may now begin processing delivery of the ordered item(s).' : "You may now begin processing the order as the customer has been notified to come pick it up at {$order->location->name}." }}</p>
