...
table, td { color: #000000; } #u_body a { color: #0000ee; text-decoration: underline; } @media (max-width: 480px) { #u_content_image_1 .v-src-width { width: auto !important; } #u_content_image_1 .v-src-max-width { max-width: 42% !important; } #u_content_heading_1 .v-font-size { font-size: 18px !important; } #u_content_text_4 .v-container-padding-padding { padding: 0px 10px 40px !important; } #u_content_text_4 .v-line-height { line-height: 170% !important; } #u_content_button_1 .v-size-width { width: 60% !important; } #u_content_text_3 .v-container-padding-padding { padding: 0px 20px 20px !important; } #u_content_image_3 .v-src-width { width: auto !important; } #u_content_image_3 .v-src-max-width { max-width: 31% !important; } }
    </style>
...
<table style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div class="v-line-height" style="line-height: 140%; text-align: center; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 14px; line-height: 19.6px;"> {{ $owcadmin['title'] }}. {{ $owcadmin['user_firstname'] }} </span></p>
  </div>
...
<table id="u_content_text_4" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  @if($owcadmin['type'] == "Visitation")
  <div class="v-line-height" style="line-height: 160%; text-align: center; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 170%;"><span style="font-size: 12px; line-height: 20.4px;">Has just successfully scheduled an appointment with <strong>One Wellness Clinic (OWC)</strong> for <strong>{{ $owcadmin['date'] }} </strong>by <strong>{{ $owcadmin['time'] }}</strong> with 
    
    <span>a</span>
    


    <strong>{{ $owcadmin['caretype'] }}.</strong></span></p>
  </div>


  @elseif($owcadmin['type'] == "Online")
  <div class="v-line-height" style="line-height: 160%; text-align: center; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 170%;"><span style="font-size: 12px; line-height: 20.4px;">Has just successfully scheduled an appointment with <strong>{{ $owcadmin['doctor'] }}</strong> on <strong>{{ $owcadmin['date'] }} </strong>by <strong>{{ $owcadmin['time'] }}</strong> 
...
<div align="center">
  <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://admin.asknello.com" style="height:37px; v-text-anchor:middle; width:203px;" arcsize="67.5%"  stroke="f" fillcolor="#d07750"><w:anchorlock/><center style="color:#FFFFFF;font-family:'Montserrat',sans-serif;"><![endif]-->  
    ...
    <a href="{{ url('https://admin.asknello.com/booking/'.$owcadmin['ref'].'') }}" target="_blank" class="v-button v-size-width" style="box-sizing: border-box;display: inline-block;font-family:'Montserrat',sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #d07750; border-radius: 25px;-webkit-border-radius: 25px; -moz-border-radius: 25px; width:35%; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;">
...
<table id="u_content_text_3" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  <tbody>
    <tr>
      ...
      @if($owcadmin['type'] == "Visitation")
  <div class="v-line-height" style="line-height: 140%; text-align: center; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 14px; line-height: 19.6px; font-family: 'Open Sans', sans-serif;"><strong>Click on the above link to download  details the appointment</strong></span></p>
  </div>
